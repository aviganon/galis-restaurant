...
export async function extractWithAI(
  ...
  if (isRtf) {
    ...
    const userContent =
      type === "p"
        ? "נתח את המסמך: חלץ שם ספק, תאריך, ולכל פריט — שם, מק\"ט, יחידה, כמות (qty). אם יש מחירים — חלץ מחיר נטו ליחידה. אם אין מחירים (תעודת משלוח) — החזר no_prices:true ו-price:0. qty חייב להיות מספר גדול מ-0. JSON בלבד."
        : type === "d"
