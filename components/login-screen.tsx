                  ...
                  <TabsContent value="register" className="space-y-4 mt-0">
                    <form onSubmit={handleRegister} className="space-y-4">
                      ...
                      <div className="rounded-xl border border-border bg-muted/30 p-3 text-sm space-y-1">
                        ...
                        <p className="text-muted-foreground">תחילה בוחרים שיטה, ואז נפתח רק הטופס המתאים.</p>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        <button
                          type="button"
                          onClick={() => setRegisterMethod("google")}
                          className={`h-11 rounded-xl border text-sm font-medium transition-colors ${registerMethod === "google" ? "border-primary bg-primary/10 text-primary" : "border-border hover:bg-muted"}`}
                        >
                          הרשמה עם Google
                        </button>
                        <button
                          ...
                          className={`h-11 rounded-xl border text-sm font-medium transition-colors ${registerMethod === "manual" ? "border-primary bg-primary/10 text-primary" : "border-border hover:bg-muted"}`}
                        >
                          הרשמה ידנית
                        </button>
                      </div>
                      {registerMethod === "none" ? (
                        <p className="text-xs text-muted-foreground">בחרו שיטת הרשמה כדי להמשיך.</p>
                      ) : null}
                      <div className="space-y-2">
                      ...
                      {registerMethod === "google" ? <div className="pt-1">
                        <button
                          type="button"
