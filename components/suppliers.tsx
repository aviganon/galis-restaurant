  ...
  return (
    <div className="container mx-auto px-4 py-6">
          ...
          {globalReorderOpen&&(
            <div className="mb-4 p-4 rounded-xl border border-blue-200 bg-blue-50/50 dark:bg-blue-950/20 dark:border-blue-800">
              ...
              <div className="flex justify-between items-center mt-3 text-xs text-muted-foreground">
                ...
                <button onClick={()=>setShowPO(true)} className="text-blue-600 hover:underline font-medium">הזמנות ספקים ←</button>
              </div>
            </div>
          )}
      ...
      <Dialog open={addSupplierOpen} onOpenChange={(o) => { setAddSupplierOpen(o); if (!o) resetAddSupplierModal() }}>
        <DialogContent className="max-w-[92vw] w-[92vw] h-[88vh] overflow-hidden flex flex-col">
