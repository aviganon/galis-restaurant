...
const TILES: Tile[] = [
  ...
  { id: "fixed-expenses", labelKey: "launcher.fixedExpenses", icon: CreditCard, gate: { kind: "optIn", key: "canSeeExpenses" } },
  { id: "expense-analysis", labelKey: "launcher.expenseAnalysis", icon: TrendingDown, gate: { kind: "optIn", key: "canSeeExpenses" } },
  { id: "income-analysis", labelKey: "launcher.incomeAnalysis", icon: TrendingUp, gate: { kind: "optIn", key: "canSeeReports" } },
  ...
  { id: "warehouses", labelKey: "launcher.warehouses", icon: Warehouse, gate: { kind: "optIn", key: "canSeeWarehouses" } },
  { id: "employees", labelKey: "launcher.employees", icon: Users, gate: { kind: "optIn", key: "canSeeEmployees" } },
  ...
  { id: "harassment", labelKey: "launcher.harassment", icon: ShieldAlert, gate: { kind: "canSee", key: "canSeeHrDocs" } },
  { id: "work-agreement", labelKey: "launcher.workAgreement", icon: FileSignature, gate: { kind: "canSee", key: "canSeeHrDocs" } },
  { id: "personal-area", labelKey: "launcher.personalArea", icon: UserCircle, destination: "settings", gate: { kind: "always" } },
  { id: "form101", labelKey: "launcher.form101", icon: FileText, gate: { kind: "canSee", key: "canSeeHrDocs" } },
  { id: "forms", labelKey: "launcher.forms", icon: Files, gate: { kind: "canSee", key: "canSeeHrDocs" } },
  { id: "accessibility", labelKey: "launcher.accessibility", icon: Accessibility, gate: { kind: "always" } },
]
